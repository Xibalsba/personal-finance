      ...
      <div class="card o-hidden border-0 shadow-lg my-5">
        <div class="card-body p-0">
          ...
          <div class="p-5">
            ...
            <?php $usuario = new UsuariosCtrl(); $usuario -> nuevoUsuario(); ?>
            <form class="user" method="post" id="formRegistro" enctype="multipart/form-data">
              ...
              <input type="file" class="dropify" id="imagenUsuarioRegistro" name="imagenUsuarioRegistro" data-max-file-size-preview="3M" data-allowed-file-extensions = "jpg png" data-height="300"  data-max-height="1800" data-min-width="100" data-max-width ="1800"/>
              <button type="submit" class="btn btn-primary btn-user btn-block mt-4">Registrar datos</button>
            </form>
            <hr>
            <div class="text-center">
